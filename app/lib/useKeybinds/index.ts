...
import { defaultNavigator, defaultWindow, useEventListener, type Arrayable } from '@vueuse/core'
import type { MaybeRefOrGetter } from 'vue'
import type {
  GetKeyCode,
  GetKeyCodeWithModifiers,
  IncludeElement,
  KeybindHandlerParams,
  KeybindNext,
  KeybindsDef,
...
import {
  buildKeybindTree,
  createDefaultGetKeyCodeWithModifiers,
  createDefaultNormalizeCombinedKeyCode,
  defaultGetKeyCode,
  defaultIncludeEvent,
  isMacOS,
  normalizeKeybindsDef,
  SEQUENCE_DELAY_MS_DEFAULT,
} from './internal'
...
export function useKeybinds(
  keybinds: KeybindsDef,
  { target = defaultWindow, event = 'keydown', ...options }: UseKeybindsOptions = {},
) {
